...
$string['course_restore'] = 'Вернуть курс из корзины';
...
$string['unsubscribe'] = 'Отписаться от этого курса';
$string['unsubscribe_alert'] = 'Вы можете отписаться от этого курса. Это никак не затронет доступ других преподавателей к этому курсу, а также не отразится на студентах.';
$string['unsubscribedfromcourse'] = 'Блокировка записи на курс: ';
$string['unsubscribingfromcourse'] = 'Вы успешно отписаны от курса: ';
...
$string['retention_days_help']    = 'Период времени, в течение которого удалённый курс хранится в корзине перед окончательным удалением. По умолчанию 40 дней.';
$string['task_delete_expired']    = 'Удаление курсов с истёкшим сроком хранения';

// Параметры ограничения очистки.
$string['max_runtime_seconds']      = 'Максимальная длительность ночной очистки';
$string['max_runtime_seconds_help'] = 'Максимальная длительность одного запуска плановой очистки. По умолчанию 15 минут (900 секунд).';
$string['max_delete_per_run']       = 'Максимум удаляемых курсов за запуск';
$string['max_delete_per_run_help']  = 'Верхняя граница количества курсов для окончательного удаления за один запуск. Укажите 0, чтобы не ограничивать.';