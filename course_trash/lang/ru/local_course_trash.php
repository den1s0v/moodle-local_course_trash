...
$string['unsubscribe_alert'] = 'Вы можете отписаться от этого курса. Это не никак затронет доступ других преподавателей к этому курсу, а также не отразится на студентах.';
